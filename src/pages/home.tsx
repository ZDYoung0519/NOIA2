      ...
      <section className="relative z-10 py-24 bg-slate-900/30 border-y border-white/5">
        <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row items-center gap-16">
          ...
          <div className="flex-1 space-y-6">
            ...
            <p className="text-slate-400 text-lg leading-relaxed">
              一键查询角色攻击力、伤害增幅等核心属性，并提供基于当前装备与 Buff
              的综合评分。 附带属性阈值推荐与养成建议，帮你快速定位提升方向。
            </p>
            <ul className="space-y-4">
              {[
                "实时同步游戏内角色数据",
            ...
            <div className="relative rounded-xl bg-slate-950 border border-slate-800 shadow-2xl overflow-hidden group">
              ...
              <div className="p-6 font-mono text-xs space-y-4">
                ...
                <div className="flex justify-between items-center">
                  <div>
                    <div className="text-slate-500 mb-1">XXX</div>
                    <div className="text-white font-bold text-lg">
                      剑星 · 天族
                    </div>
                    <div className="text-slate-400 text-xs">服务器: XXX</div>
                  </div>
                  <div className="text-right">
                    <div className="text-slate-500 mb-1">综合评分</div>
                    <div className="text-3xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-cyan-400">
                      2845
                    </div>
                    <div className="text-slate-500 text-xs">S 级</div>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-2 gap-4 mt-4">
                  {[
                    { label: "攻击力", value: "850", max: "900" },
                    { label: "伤害增幅", value: "45%", max: "50%" },
                    { label: "暴击", value: "1200", max: "1500" },
                    { label: "命中", value: "980", max: "1000" },
                  ].map((attr, i) => (
                    <div key={i}>
                      ...
                      <div className="w-full h-1.5 bg-slate-800 rounded-full mt-1 overflow-hidden">
                        <div
                          ...
                          style={{
                            width: `${(parseInt(attr.value) / parseInt(attr.max)) * 100}%`,
                          }}
                        />
                      </div>
                    </div>
                ...
                <div className="mt-4 pt-4 border-t border-slate-800">
                  <div className="text-slate-400 mb-2">养成建议</div>
