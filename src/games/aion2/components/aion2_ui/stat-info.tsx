...
import { Tooltip, TooltipTrigger, TooltipContent } from "@/components/custom-tooltip";
import { Separator } from "@/components/ui/separator";
import { getStatSum } from "@/games/aion2/lib/stat-utils";
          ...
          <div className="">
            <div className="flex flex-col items-center gap-0 p-0">
              ...
              <div className="flex h-12 w-12 items-center justify-center rounded-full transition-colors">
                <img
                  src={`/aion2/stat_${stat.type.toLowerCase()}.png`}
                  alt={stat.name}
        ...
        <TooltipTrigger asChild>
          <div className="p-0">
            <div className="flex flex-col items-center">
              ...
              <div className="mb-1">
                <img
                  src={`/aion2/stat_lords_${stat.type.toLowerCase()}.png`}
                  alt={displayName}
                  className="h-6 w-6 object-contain"
                  onError={(e) => {
                    e.currentTarget.src = "/aion2/stat_default.png";
                  }}
                />
              </div>
