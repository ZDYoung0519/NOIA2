...
import {
  ...
  type HomeNewsData,
} from "@/games/aion2/lib/fetchHomeNews";
  ...
  return (
    <section className="overflow-hidden rounded-md border border-white/15 bg-black/45 shadow-2xl backdrop-blur-xl">
      <div className="relative h-[300px] overflow-hidden bg-black/20">
        {state.loading ? <SpinnerOverlay label={t("aion2Home.loading")} /> : null}
        ...
        {!state.loading && activeSlide ? (
          ...
          >
            ...
            {imageLoading ? <SpinnerOverlay label={t("aion2Home.loadingImage")} /> : null}
      ...
      <div className="px-4 py-3">
        <div className="mb-3 flex items-center justify-between">
          <div className="flex items-center gap-7">
            <NewsTabButton
              ...
              label={t("aion2Home.notice")}
              onClick={() => setActiveTab("notice")}
            />
            <NewsTabButton
              active={activeTab === "update"}
              label={t("aion2Home.update")}
        ...
        {state.loading ? (
          ...
          <div className="py-6 text-center text-sm text-white/60">{t("aion2Home.noContent")}</div>
        )}
      </div>
    </section>
  );
