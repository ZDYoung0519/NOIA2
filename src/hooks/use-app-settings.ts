  ...
  return {
    ...
    appearance: {
      ...
      dpsWindow: {
        ...
        showUnknownActors:
          input?.appearance?.dpsWindow?.showUnknownActors ??
          DEFAULT_APP_SETTINGS.appearance.dpsWindow.showUnknownActors,
        pingWindowAlignment:
